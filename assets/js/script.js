      ...
      navigator.bluetooth.requestDevice(options)
        .then(device => {
            for (const device of devices) {
                ...
                if (device.name == "FitBrix" || device.name == "Arduino" || device.id == "e2D6KSLwZCC8CzY+W+5FjA==") {
                    state = false;
...
const firebaseConfig = {
    ...
    apiKey: "AIzaSyCNZCMytUQzl5S7qzA1rgGz3Q7YkbgvG_8",
    authDomain: "fitbrix-5515d.firebaseapp.com",
    projectId: "fitbrix-5515d",
    storageBucket: "fitbrix-5515d.appspot.com",
    messagingSenderId: "237533251538",
    appId: "1:237533251538:web:c94ff126865a6246c16a0b",
    measurementId: "G-5FDS7KNDTT",
    databaseURL: "https://fitbrix-5515d-default-rtdb.asia-southeast1.firebasedatabase.app/"
};
